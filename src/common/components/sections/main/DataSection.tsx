...
export default function DataSection(data: FeaturedMovieInterface["data"]) {
  return (
    <TransitionComponent>
      <img
        src={`${config.TMDB_APIIMAGEURL}${data.backdropPath}`}
        className="w-full h-screen object-cover object-center pointer-events-none absolute"
      />
      ...
      <div className="flex flex-col justify-end w-full h-screen py-10 px-4 md:px-16 absolute">
        <span className="text-custom-first font-poppins font-bold text-4xl lg:text-7xl line-clamp-1 mb-4">
          {data.title}
        </span>
        <div className="flex">
          <div className="flex flex-col xl:w-2/4">
            <span className="text-custom-first font-poppins font-normal text-xl mb-12">
              {data.description}
            </span>
            <div className="flex">
              ...
              <div className="flex flex-col w-1/2 justify-center">
                <MovieFact
                  ...
                  iconColor={theme.colors.custom.accent}
                  text={
                    data?.rateCertification?.find(
                      (el) => el.iso_3166_1 === "US" || el.iso_3166_1 === "NL"
                    )?.certification
                  }
              ...
              <div className="flex flex-col w-full justify-center">
                <div className="flex">
                  <button className="w-1/4 text-custom-first font-poppins text-base py-4 bg-custom-first bg-opacity-20 hover:bg-opacity-30 focus:bg-opacity-10 rounded-xl">
                    INFO
                  </button>
